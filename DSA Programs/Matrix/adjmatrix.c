...
void print_connected_matrix(int adj_matrix[MAX][MAX],int);
...
int main()
{
    ...
    while(1)
    {
        printf("\n1.Undirected Graph...");
        printf("\n2.Directed Graph...");
        printf("\n3.Print Adjacency Matrix(complete)...");
        printf("\n4.Print Adjacency Matrix(connected only)...");
        printf("\n5.Exit...");
        printf("\nEnter your choice...");
        scanf("%d",&choice);
        switch(choice)
        {
            ...
            break;
            case 4:
            print_connected_matrix(adj_matrix,n);
            break;
            case 5:
            exit(1);
        }
...
void print_connected_matrix(int adj_matrix[MAX][MAX],int n)
{
    int i,j;
    printf("\nConnected Matrix is...");
    for(i=1;i<=n;i++)
